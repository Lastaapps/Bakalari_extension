...
class ThemesRepository(
    ...
    RefreshingServerRepo<ThemeList>(
        TAG, database, "subjects/themes/$subjectId"
    ) {
    ...
    override fun lastUpdatedTables(): List<String> = listOf(APIBaseKeys.THEMES + subjectId)
    ...
    override suspend fun parseData(json: JSONObject): ThemeList =
        cz.lastaapps.bakalari.api.entity.themes.ThemesParser.parseJson(json)
