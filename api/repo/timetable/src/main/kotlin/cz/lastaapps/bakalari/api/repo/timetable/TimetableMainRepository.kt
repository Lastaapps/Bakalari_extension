...
class TimetableMainRepository(private val database: cz.lastaapps.bakalari.api.database.APIBase) :
    Deletable {
    ...
    companion object {
        ...
        fun loadDefault(context: Context): cz.lastaapps.bakalari.api.entity.timetable.Week {
            ...
            return cz.lastaapps.bakalari.api.entity.timetable.TimetableParser.parseJson(
                TimeTools.now.toDate(),
                JSONObject(string)
            )
        }
    }
