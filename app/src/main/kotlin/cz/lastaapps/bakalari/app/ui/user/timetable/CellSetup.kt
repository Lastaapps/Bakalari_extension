...
import cz.lastaapps.bakalari.api.entity.timetable.Change.Companion.getStringId
    ...
    class ShowLessonInfo(
        ...
        private fun addInfo(binding: TimetableLessonInfoBinding, dialog: AlertDialog) {
            ...
            binding.apply {
                ...
                addInfoRow(
                    ...
                    user.runIfFeatureEnabled(User.SUBJECTS_SHOW) {
                        (binding.root.context as AppCompatActivity)
                            ...
                            .navigate(
                                NavGraphUserDirections.actionSubjectInfo(lesson.subjectId)
                            )
                ...
                addInfoRow(
                    ...
                    user.runIfFeatureEnabled(User.SUBJECTS_SHOW) {
                        (binding.root.context as AppCompatActivity)
                            .findNavController(R.id.nav_host_fragment)
                            .navigate(
                                NavGraphUserDirections.actionTeacherInfo(lesson.teacherId)
                            )
                    }
                }
                ...
                addInfoRow(
                    table,
                    lesson.change.getStringId()?.let { App.getString(it) },
            ...
            if (homework != null) {
                ...
                if (homeworkList.isNotEmpty()) {
                    ...
                    binding.homeworkList.apply {
                        adapter =
                            BasicRecyclerAdapter({ it.content }, homeworkList).apply {
                                onItemClicked = {
