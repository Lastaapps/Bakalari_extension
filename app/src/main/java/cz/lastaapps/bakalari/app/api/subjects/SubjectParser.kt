...
package cz.lastaapps.bakalari.app.api.subjects

import android.util.Log
import cz.lastaapps.bakalari.app.api.subjects.data.*
...
object SubjectParser {
    ...
    fun parseJson(root: JSONObject): SubjectTeacherLists {
        ...
        val jsonArray = root.getJSONArray("Subjects")
            ...
            return SubjectTeacherLists(sList, TeacherList(tList))
