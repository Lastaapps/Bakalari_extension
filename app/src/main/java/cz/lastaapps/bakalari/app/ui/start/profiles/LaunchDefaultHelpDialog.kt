...
class LaunchDefaultHelpDialog : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return createDialog(requireContext(), container)
            .setDialogTitle(R.string.profile_help_launch_title)
            .setDialogMessage(R.string.profile_help_launch_message)
            .setPositiveButton(R.string.profile_help_launch_button) {
                dismiss()
            }
    }
