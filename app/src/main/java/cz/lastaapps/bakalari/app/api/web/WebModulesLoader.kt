...
package cz.lastaapps.bakalari.app.api.web

import android.content.Context
import android.util.Log
import cz.lastaapps.bakalari.app.api.ConnMgr
...
class WebModulesLoader {
    companion object {
        ...
        suspend fun loadFromServer(appContext: Context, account: BakalariAccount): WebRoot? {

            Log.i(TAG, "Loading from server")

            val json = ConnMgr.serverGet(appContext, account, "webmodule") ?: return null
