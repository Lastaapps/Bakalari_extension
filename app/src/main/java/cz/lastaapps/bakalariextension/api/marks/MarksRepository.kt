...
import cz.lastaapps.bakalariextension.api.database.RefreshingAssetRepo
import cz.lastaapps.bakalariextension.api.marks.data.*
...
//: APIServerRepo<MarksSubjectMarksLists>(TAG, database, "marks") {
